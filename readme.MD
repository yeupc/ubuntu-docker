...
`docker run --name identity-service --network devteria-network -p 8080:8080 -e DBMS_CONNECTION=jdbc:mysql://mysql:3306/identity_service -d yeupc/n8n:0.9.0`
...
# Video: https://www.youtube.com/watch?v=ZZpB4Lgx1rk
